...
class LDAModel:
    ...
    def train(self, data, passes):
        ...
        if self.word_dict == None:
            ...
            return
        if self.model == None:
            self.model = LdaModel(num_topics=self.vector_length, id2word=self.word_dict, alpha='auto')#, eta='auto')
        ...
        try:
            ...
            self.model.update(datastream, passes=passes, chunksize=20000, iterations=500)
    ...
    def fit(self, data):
        ...
        try:
            ...
            for i in range(len(datastream)):
                ...
                for element in self.model[datastream[i]]:#self.model.get_document_topics(datastream[i], minimum_probability=0.0):
